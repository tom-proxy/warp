...
const DataBase = {
	"Panel": {
		"Settings":{"Switch":true,"Title":"🌩️𝓩𝓮𝓻𝓸𝓣𝓻𝓾𝓼𝓽🌩️","Icon":"lock.icloud.fill","IconColor":"#f48220","BackgroundColor":"#f6821f","Language":"auto"},
		"Configs": {
...
(async () => {
	...
	switch (Settings.Switch) {
		...
		default:
			...
			// 构造面板信息
			let Panel = {};
			if ($.isStash()) Panel.title = Settings?.Title ?? "🌩️𝓩𝓮𝓻𝓸𝓣𝓻𝓾𝓼𝓽🌩️"
			else Panel.title = Settings?.Title ?? "🌩️𝓩𝓮𝓻𝓸𝓣𝓻𝓾𝓼𝓽🌩️"
			// 填充面板信息
			if ($.isLoon() || $.isQuanX()) {
